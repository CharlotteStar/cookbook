  ...
  <div class="container">
    ...
    <div class="sancan_top">
      <div class="classify">
        ...
        <div class="today_classify">
          <span class="m m1" id="slide">早餐</span>
          <span class="m m2">午餐</span>
          <span class="m m3">下午茶</span>
          <span class="m m4">晚餐</span>
      ...
      <div class="sancan_view">
        <div
          ...
          @touchend="slide_end"
        >
          <div class="sancan_slide" v-for="i in 5" :key="i">
...
export default {
  ...
  methods: {
    ...
    slide_move(e) {
      ...
      sancan_list.style.marginLeft=`${this.offset_x}px`;
      this.prev_x=now_x;
    },
    slide_end(e) {
...
.FourPlates span div:nth-child(1) {
  color: #000;
  font-size: 14px;
  padding: 5px 0 0 5px;
}
.FourPlates span div:nth-child(2) {
  color: #333;
  font-size: 12px;
  padding-bottom: 10px;
